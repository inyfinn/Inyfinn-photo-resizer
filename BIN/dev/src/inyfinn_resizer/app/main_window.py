...
class MainWindow(QMainWindow):
    ...
    def _build_convert_body(self) -> QWidget:
        ...
        prev_thumb_row = QHBoxLayout()
        prev_thumb_row.setSpacing(6)
        self.preview_label = QLabel()
        self.preview_label.setObjectName("previewBox")
        self.preview_label.setFixedSize(40, 40)
        self.preview_label.setAlignment(Qt.AlignCenter)
        self.size_info = QLabel("")
        self.size_info.setObjectName("previewMeta")
        self.size_info.setWordWrap(True)
        prev_thumb_row.addWidget(self.preview_label)
        prev_thumb_row.addWidget(self.size_info, stretch=1)
        prev_col.addLayout(prev_thumb_row)
