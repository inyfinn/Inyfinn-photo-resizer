...
_SECTION_TOKENS: dict[str, dict[str, str]] = {
    ...
    "dark": {
        ...
        "@S2_SELECT_BG@": "#0d9488",
        "@S2_TOOL_HOVER@": "#0d9488",
        "@S3_INPUT_BORDER@": "#9a5c32",
        "@S3_INPUT_HOVER_BG@": "#2e2318",
        "@S3_INPUT_HOVER_BORDER@": "#fb923c",
        "@S3_CHECK_BORDER@": "#c2783a",
        "@S3_CHECK_BG@": "#ea580c",
        "@S3_CHECK_BORDER_ON@": "#fb923c",
        "@S3_BTN_PRIMARY@": "#ea580c",
        "@S3_BTN_PRIMARY_HOVER@": "#c2410c",
        "@S3_BTN_PRIMARY_BORDER@": "#9a3412",
        "@S3_BTN_BROWSE_BORDER@": "#fb923c",
        "@S3_BTN_BROWSE_TEXT@": "#fdba74",
        "@S3_BTN_BROWSE_HOVER_BG@": "#2e2318",
        "@S3_BTN_BROWSE_HOVER_BORDER@": "#fb923c",
        "@S3_BTN_BROWSE_HOVER_TEXT@": "#ffedd5",
