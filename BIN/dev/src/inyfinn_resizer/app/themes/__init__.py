...
_SECTION_TOKENS: dict[str, dict[str, str]] = {
    "light": {
        "@S1_GROUP_BG@": "rgba(99, 102, 241, 0.04)",
        "@S1_GROUP_BORDER@": "#d8dae8",
        "@S1_CTRL_BORDER@": "#c5c9dc",
        "@S1_DROPDOWN_BG@": "#f8f8fb",
        "@S1_HOVER_BG@": "#f3f4f8",
        "@S1_HOVER_BORDER@": "#a8acc4",
        "@S1_FOCUS_BORDER@": "#8b90b0",
        "@S1_SLIDER_GROOVE@": "#dde0ea",
        "@S1_SLIDER_HANDLE@": "#7c82a8",
        "@S1_SLIDER_FILL@": "#a8acc4",
        "@S1_CHECK_BORDER@": "#a8acc4",
        "@S1_CHECK_BG@": "#7c82a8",
        "@S1_CHECK_BORDER_ON@": "#6b7194",
        "@S1_VALUE@": "#5b5f7a",
        "@S1_BTN_TEXT@": "#5b5f7a",
        "@S1_SELECT_BG@": "#7c82a8",
        "@S2_DROPDOWN_BG@": "#f4f6f5",
        "@S2_HOVER_BG@": "#eef1ef",
        "@S2_HOVER_BORDER@": "#9aa8a3",
        "@S2_FOCUS_BORDER@": "#7a8a84",
        "@S2_CTRL_BORDER@": "#c5cec9",
        "@S2_SLIDER_GROOVE@": "#dce3df",
        "@S2_SLIDER_HANDLE@": "#7a8a84",
        "@S2_SLIDER_FILL@": "#a8b5af",
        "@S2_CHECK_BORDER@": "#a8b5af",
        "@S2_CHECK_BG@": "#7a8a84",
        "@S2_CHECK_BORDER_ON@": "#6a7a74",
        "@S2_VALUE@": "#4a5f6b",
        "@S2_SELECT_BG@": "#7a8a84",
        "@S2_TOOL_HOVER@": "#7a8a84",
        "@S3_INPUT_BORDER@": "#d8cfc4",
        "@S3_INPUT_HOVER_BG@": "#f5f1ec",
        "@S3_INPUT_HOVER_BORDER@": "#b8a998",
        "@S3_CHECK_BORDER@": "#c9bfb2",
        "@S3_CHECK_BG@": "#a89888",
        "@S3_CHECK_BORDER_ON@": "#8a7a6a",
        "@S3_BTN_PRIMARY@": "#a89888",
        "@S3_BTN_PRIMARY_HOVER@": "#8a7a6a",
        "@S3_BTN_PRIMARY_BORDER@": "#8a7a6a",
        "@S3_BTN_BROWSE_BORDER@": "#b8a998",
        "@S3_BTN_BROWSE_TEXT@": "#6b5f52",
        "@S3_BTN_BROWSE_HOVER_BG@": "#f5f1ec",
        "@S3_BTN_BROWSE_HOVER_BORDER@": "#8a7a6a",
        "@S3_BTN_BROWSE_HOVER_TEXT@": "#5a4f44",
